...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Optional<Entreprise> entrepriseOptional = entrepriseRepository.findById(signUpRequest.getEntrepriseId());
		if (!entrepriseOptional.isPresent()) {
			return ResponseEntity
					.badRequest()
					.body(new MessageResponse("Error: Entreprise ID is invalid!"));
		}
		...
		User user = new User(signUpRequest.getUsername(),
				...
				,signUpRequest.getSiteId());
		user.setEntreprise(entrepriseOptional.get());
